...
% Materiale iniziale
%******************************************************************
\input{materiale-iniziale-finale/frontespizio}
\input{materiale-iniziale-finale/indici}
\input{materiale-iniziale-finale/introduzione}
\cleardoublepage
...
%******************************************************************
\mainmatter
\input{capitoli/bitcoin}
\input{capitoli/ethereum}
\input{capitoli/takamaka}
\input{capitoli/metodi-java-non-deterministici}
\appendix
...
%******************************************************************
\backmatter
\input{materiale-iniziale-finale/conclusioni}
\input{materiale-iniziale-finale/bibliografia}
\end{document}